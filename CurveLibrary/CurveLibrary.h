...
/// Vector in 3D space.
/// </summary>
extern CURVELIBRARY_API class Vector3D
{
public:
	...
	/// <param name="y">Ordinate.</param>
	/// <param name="z">Applicate.</param>
	CURVELIBRARY_API Vector3D(double x, double y, double z);
...
public:
	...
	CURVELIBRARY_API virtual Vector3D getDerivative(double t) const = 0;
};
...
#pragma region Methods
	...
	/// <param name="t">Parameter.</param>
	/// <returns>Derivative.</returns>
	CURVELIBRARY_API Vector3D getDerivative(double t) const override;
